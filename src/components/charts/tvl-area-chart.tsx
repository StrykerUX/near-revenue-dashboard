...
export function TvlAreaChart({ data }: { data: TimeSeriesPoint[] }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={data} margin={{ top: 16, right: 60, left: 10, bottom: 0 }}>
        <defs>
          <linearGradient id="tvlGradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--near-green)" stopOpacity={0.4} />
            <stop offset="75%" stopColor="var(--near-green)" stopOpacity={0.08} />
            <stop offset="100%" stopColor="var(--near-green)" stopOpacity={0.01} />
          </linearGradient>
        </defs>
